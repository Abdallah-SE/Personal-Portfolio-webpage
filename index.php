        ...
        <div class="portfolio-container">
            <nav id="navbar">
                <ul>
                    ...
                    <li><a href="#projects">Some of my Works</a></li>
            ...
            <section id="welcome-section">
                <h1>Marhaba, I'm Abdallah Mahmoud.</h1>
                <h2>A Web Developer</h2>
                <button>Hire Me</button>
            </section>
            <div class="head-recommend">
                <div class="text-in-center"><!--Content of the the heading of my works-->
                    <h1 class="head-text">Some Of My Works...</h1>
                </div>
            </div>
            <section id="projects">  
                    ...
                    <div class="project-tile">
                        ...
                        <div class="detail-container">
                            <p><strong style="display:block;">Tribute Page</strong>
                                ...
                                Basically an overview of someone whom we admire in our life.
                            </p>

                            <hr>
                            <p id="click-me">Click To See It live</p>
                        </div>
                    ...
                    <div class="project-tile">
                        ...
                        <div class="detail-container">
                            <p><strong style="display:block;">Survey Form Page</strong>
                                It's with Responsive Web Designing
                                Form to gather information about people
                            </p>
                    ...
                    <div class="project-tile">
                        ...
                        <div class="detail-container">
                            <p><strong style="display:block;">Product Landing Page</strong>
                                It's with Responsive Web Designing
                                Product landing page is used to promote and sell products or services.
                            </p>
                    ...
                    <div class="project-tile">
                        ...
                        <div class="detail-container">
                            <p><strong style="display:block;">Technical Documentation Page</strong>
                                It's with Responsive Web Designing
                                Generic term for the classes of information of use System or product.
                            </p>
                    ...
                    <div class="project-tile">
                        ...
                        <div class="detail-container">
                            <p><strong style="display:block;">Simple Image Gallery</strong>
                                It's with Responsive Web Designing
                                A collection of pictures with toggle option to see one by one.
                            </p>
                    ...
                    <div class="project-tile">
                        ...
                        <div class="detail-container">
                            <p><strong style="display:block;">Online Books Page</strong>
                                It's with Responsive Web Designing
                                Bookstore with cheap new & used books at good prices. 
                            </p>
                            <hr>
                            <p id="click-me">Click To See It live</p>
                        </div>
